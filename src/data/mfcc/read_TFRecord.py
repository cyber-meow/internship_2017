"""Read TFRecords and provide data for the audio part of AVLetters.
...
def get_split_mfcc(split_name,
                   ...
                   reader=None,
                   num_frames=24):
    """Gets a dataset tuple for reading mfcc audio features.
    ...
    Args:
        ...
        num_frames: The number of frames contained in each audio sample
...
def load_batch_mfcc(dataset,
    ...
    Args:
        ...
        batch_size: The number of audios in the batch.
