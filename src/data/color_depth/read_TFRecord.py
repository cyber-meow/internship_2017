"""Read TFRecords and provide data for color-depth image pairs.
...
def load_batch_color_depth(dataset,
    ...
    Args:
        ...
        batch_size: The number of image pairs in the batch.
    ...
    Returns:
        images_color: A `Tensor` of size [batch_size, height, width, channels],
            RGB image samples that have been preprocessed.
        images_depth: A `Tensor` of size [batch_size, height, width, channels],
